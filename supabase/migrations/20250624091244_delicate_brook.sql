/*
  ...
  1. New Tables
    - `post_reactions` - Stores user reactions to posts (stars and shits)
    - Tracks which user reacted to which post and how

  2. Changes
    - Add reaction tracking for posts
    - Allow users to give star (positive) or shit (negative) reactions
    - Track reaction counts per post

  3. Security
    - Enable RLS on reaction table
    - Add policies for users to manage their own reactions
    - Allow reading aggregated reaction data
*/
